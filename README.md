...
Angular starter laid on top.

## Origin

    npx @angular/cli@20 new angular --skip-install --defaults
...
| install | `npm install` |
| build | `npm run build` |
| start | `npx serve -s dist/angular/browser -l $PORT` |
...
- Angular CLI pinned to 20: CLI 21+ requires Node >= 22.22.3.
